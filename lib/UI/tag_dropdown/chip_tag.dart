...
class ChipTag extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return chipContent.getLabelText()=="" ? Container() : Card( //return empty container if empty text
      color: color,
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(Dimensions.cornerRadiusSmall)),
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            Text(chipContent.getLabelText(), style: Theme.of(context).textTheme.labelSmall,), //finishs chip
            /*
            optional delete iconButton
             */
              if(deletable) ...[ //add the delete button to the chip
                const SizedBox(width: Dimensions.spaceVerySmall,),
                IconButton.filledTonal(onPressed: () => onDelete(chipContent),
                  icon: const Icon(Icons.close),
                  iconSize: Dimensions.iconSizeVerySmall,
                  constraints: const BoxConstraints( //make button including hitbox smaller
