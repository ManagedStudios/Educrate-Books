...
class LfgSearchbar extends StatefulWidget {
  const LfgSearchbar(
      ...
      required this.amountOfFilteredItems,
  ...
  final int
      amountOfFilteredItems; //amount of students/books that are retrieved after applying filters
...
class _LfgSearchbarState extends State<LfgSearchbar> {
  ...
  Widget build(BuildContext context) {
    return SearchBar(
      ...
      trailing: [
        Padding(
          //trailing displays the amount of students
          padding: const EdgeInsets.all(Dimensions.paddingSmall),
          child: Text(
            "${widget.amountOfFilteredItems} ${widget.amountType}",
      ...
      onSubmitted: (text) =>
          textEditingController.clear(), //on enter searchbar should be cleared
