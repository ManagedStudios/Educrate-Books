...
import 'package:buecherteam_2023_desktop/UI/desktop/chips/chip_display_row.dart';
import 'package:buecherteam_2023_desktop/UI/desktop/classes/class_box.dart';
        ...
        builder: (context, state, _) => StreamBuilder(
              ...
              builder: (context, books) => books.data?.length != 1
                  ...
                  : Column(
                      ...
                      children: [
                          const SizedBox(
                            height: Dimensions.spaceLargeTimes2,
                          ),
                          Card(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          Text(
                                            "${books.data![0].subject} ${books.data![0].classLevel}",
                                      ...
                                      ClassBox(
                                          classContent: books
                                              ...
                                              .toString(),
                                          radius: Dimensions
                                              .cornerRadiusBetweenSmallAndMedium,
                                          dark: true)
                                    ],
                                  ),
                                  const SizedBox(
                                  ...
                                  const SizedBox(
                                    height: Dimensions.spaceVerySmall,
                                  ),
                                  ...
                                  Row(
                                    children: [
                                      Expanded(
                                        child: Text(
                                          "${books.data![0].amountInStudentOwnership} ${TextRes.bookAmountInStudentOwnershipDisplay}",
                                          overflow: TextOverflow.ellipsis,
                                        ),
                                      )
                                    ],
                                  ...
                                  Row(
                                    children: [
                                      Text(
                                        TextRes.trainingDirectionsDisplay,
                                        style: Theme.of(context)
                                            .textTheme
                                            .displaySmall,
                                      ),
                                  ...
                                  ChipDisplayRow(
                                      chips: books.data![0].trainingDirection),
                                  const SizedBox(
                                    height: Dimensions.spaceSmall,
                                  ),
