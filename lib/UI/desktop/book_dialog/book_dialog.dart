...
import 'package:buecherteam_2023_desktop/UI/desktop/book_dialog/book_dialog_content.dart';
...
class _BookDialogState extends State<BookDialog> {
  ...
  void initState() {
    ...
    trainingDirections = widget.book?.trainingDirection
            .map((e) => TrainingDirectionsData(e))
            .toList() ??
        [null];
    setAvailableClassLevel(
              ...
              if (isDataValid()) {
                if (bookId != null) {
                  ...
                  context.pop(Book(
                      ...
                      amountInStudentOwnership:
                          widget.book!.amountInStudentOwnership,
                      nowAvailable: int.parse(amount) -
                          widget.book!.amountInStudentOwnership,
  ...
  void onTrainingDirectionsChanged(
  ...
  bool isTrainingDirectionsValid(
      List<TrainingDirectionsData?> trainingDirections) {
  ...
  bool isDataValid() {
    updateErrors();
    return isBookNameValid(bookName) &&
