...
class BookDialogContent extends StatefulWidget {
  const BookDialogContent(
      ...
      required this.bookNameError,
      required this.bookSubjectError,
      required this.classLevelError,
      required this.amountError,
      required this.onBookSubjectChanged,
      required this.onClassLevelChanged,
      required this.onAmountChanged,
      required this.onTrainingDirectionsChanged,
      required this.book,
      required this.onIsbnChanged,
...
class _BookDialogContentState extends State<BookDialogContent> {
  ...
  void initState() {
    ...
    final initialTrs = widget.book
        ?.trainingDirection //in order to pertain the nullability of TrainingDirectionsData we cannot just map - is just the way how flutter handles types
      ...
      child: Column(
        ...
        children: [
          if (widget.isFullyEditable == null || widget.isFullyEditable == false)
            Text(
              TextRes.bookDialogNotFullyEditable,
          ...
          Padding(
            ...
            child: Text(
              TextRes.trainingDirectionsAdd,
              style: Theme.of(context).textTheme.bodyLarge,
            ),
          ),
          Expanded(
              child: IgnorePointer(
            ignoring: widget.isFullyEditable != null
                ? !widget.isFullyEditable!
                : true,
